...
insert into student values (1111, 'stud1', 'Christine', 'Legge', 'CPSC');
insert into student values (2222, 'stud2', 'Jason', 'Masih', 'CPSC');
insert into student values (3333, 'stud3', 'Darren', 'Matis', 'CPSC');
insert into student values (4444, 'stud4', 'Callum', 'Campbell', 'COGS');
insert into student values (5555, 'stud5', 'Jordan', 'Deo', 'MATH');
insert into student values (6666, 'stud6', 'Vineet', 'Lee', 'PSYC');
insert into student values (7777, 'stud7', 'Justin', 'Thomson', 'COMM');
insert into student values (8888, 'stud8', 'Alex', 'Woods', 'CHIN');
insert into student values (9999, 'stud9', 'Caledonia', 'Li', 'PHYS');
insert into student values (1010, 'stud10', 'Maggie', 'Jenni', 'ASTR');
insert into student values (1100, 'stud11', 'Nicole', 'Miland', 'ENGL');
insert into student values (1212, 'stud12', 'Nick', 'Coblin', 'CRWR');
insert into student values (1313, 'stud13', 'Christina', 'Pyde', 'ARTH');
insert into student values (1414, 'stud14', 'Juliana', 'Saxvik', 'ANTH');
insert into student values (1515, 'stud15', 'Aaron', 'Geddes', 'SOCI');
insert into student values (1616, 'stud16', 'Natalie', 'Jarvis', 'POLI');
insert into student values (1717, 'stud17', 'Emily', 'Mriso', 'STAT');
insert into student values (1818, 'stud18', 'Alison', 'del Val', 'BIOL');
insert into student values (1919, 'stud19', 'Andrew', 'Janz', 'COMM');
insert into student values (2020, 'stud20', 'Rupert', 'Gray', 'FREN');
